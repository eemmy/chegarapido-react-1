          ...
          <div className="container">
            <div className="row">
              <div className="col-12 col-md-7 col-lg-8 text-center text-md-start">
                ...
                <p className="text-white opacity-75 mb-5" style={{ maxWidth:"540px", }}>
              ...
              <div className="col-12 col-md-5 col-lg-4 position-relative">
                ...
                >
                  <h4 className="mb-4">
                    Seja nosso <br />
                    <span className="text-primary fw-bold">franqueado!</span>
                  </h4>
                  ...
                  <div className="input-group input-group-rounded-pill mb-2">
                    ...
                    <select className="form-select" aria-label="Tipo do produto">
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-12 col-md-6 text-center">
              <img
                src="./assets/images/entregador.png"
        ...
        <div className="container">
          <div className="row">
            <div className="text-center mb-5">
              <h2 className="mb-4">
                <span className="text-primary fw-bold">Lorem ipsum</span> dolor sit
                amet!
              </h2>
              <p style={{ maxWidth:"770px", color:"#373737", }} className="mx-auto">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam
                venenatis at nunc vel lobortis.{" "}
                <strong>Integer leo nibh</strong>, vestibulum et condimentum
                vel, cursus sed risus.
...
export default RegisterFranchised;
